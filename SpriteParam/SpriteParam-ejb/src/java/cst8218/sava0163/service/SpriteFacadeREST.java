 ...
 * Method : create(),edit(),remove(),find(),findAll(),findRange(),countREST(),getEntityManager
 * Constructor : SpriteFacadeREST()
 * Description : this extends the AbstractFacade. It create the sprite entity, 
 *               it can be edited from user and also destory entity by the user. there is 
 *               @PersistenceContext(unitName = "SpriteParam-ejbPU") which is the 
 *               persistence unit name which connects the data source and allows to displays the data on web-page (list.xhtml).
 */
@Stateless
@Path("cst8218.sava0163.entity.sprite")
